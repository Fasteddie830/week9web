    ...
    return(
        <div>
            ...
            <ul style = {{listStyle:"none"}}>
                ...
                <li>Total fat per serving: {item.fat_total_g} g</li>
                <li>Saturated fat per serving: {item.fat_saturated_g} g</li>
                <li>Protein content per serving: {item.protein_g} g</li>
                <li>Total carbs per serving: {item.carbohydrates_total_g} g</li>
